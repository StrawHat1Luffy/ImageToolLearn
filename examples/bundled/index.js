...
import Instagram from '@ImageToolLearn/instagram'
import GoogleDrive from '@ImageToolLearn/google-drive'
...
import '@ImageToolLearn/url/dist/style.css'
import '@ImageToolLearn/webcam/dist/style.css'
...
const ImageToolLearn = new ImageToolLearn({
  ...
  .use(Dashboard, {
    ...
    proudlyDisplayPoweredByImageToolLearn: true,
...
// see more at https://ImageToolLearn.io/docs/golden-retriever/
//
//   .use(GoldenRetriever, { serviceWorker: true })

ImageToolLearn.on('complete', (result) => {
